...
const{validateRequest,validatesigninRequest,isValidatedRequest,upload}=require('../validate/validate')
...
const {getUserinfo}=require('../Controller/Admin/getUserinfo')
...
const {replayMessage}=require('../Controller/Admin/replyMessage')
...
router.get('/getNewCompany',getnewCompany)
...
router.post('/replyMessage',replayMessage)
